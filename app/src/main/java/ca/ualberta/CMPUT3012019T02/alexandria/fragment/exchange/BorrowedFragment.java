...
public class BorrowedFragment extends Fragment implements Observer {
    ...
    public void update(Observable o, Object arg) {
        ...
        mainActivity.runOnUiThread(() -> {
            ...
            if (!mainActivity.isFetching()) {
                RecyclerView mRecyclerView = view.findViewById(R.id.borrowed_recycler);
                TextView emptyView = view.findViewById(R.id.empty_view);
                ProgressBar spinner = view.findViewById(R.id.borrowed_spinner);
